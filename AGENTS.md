...
This file provides compact guidance for Codex when working in this repository. Keep it short; detailed references live in indexed docs.
...
Archive folders are historical context, not active plans. If an archived document conflicts with code, `STATUS.md`, or `PLAN.md`, treat code and active docs as current.
